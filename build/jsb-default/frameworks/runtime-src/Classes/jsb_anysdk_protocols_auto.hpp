...
bool js_anysdk_framework_ProtocolIAP_constructor(JSContext *cx, uint32_t argc, jsval *vp);
void js_anysdk_framework_ProtocolIAP_finalize(JSContext *cx, JSObject *obj);
